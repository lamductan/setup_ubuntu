...
APP_ICON_DIR=$LOCAL_DIR/share/icons
...
cp $LOCAL_DIR/opt/google/chrome/product_logo_256.png $APP_ICON_DIR/chrome.png
...
cp $LOCAL_DIR/usr/share/pixmaps/com.visualstudio.code.png $APP_ICON_DIR/com.visualstudio.code.png
cd $HOME
...
cp $LOCAL_DIR/usr/share/pixmaps/skypeforlinux.png $APP_ICON_DIR/skypeforlinux.png
cd $HOME
...
cp $OPT_DIR/sublime_text_3/Icon/256x256/sublime-text.png $APP_ICON_DIR/sublime-text.png
cd $HOME
